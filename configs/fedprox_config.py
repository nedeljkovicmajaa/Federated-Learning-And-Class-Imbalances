...
INITIAL_FED_PATH = "/home/mn628/FEDERATED_LEARNING/mn628/results/seg_fedprox/"


PROBLEM_TYPE = "normal/"  # 'statstical_het/', 'system_het/' or just 'normal/'
chosen_dataset = "data"  # 'data' for the full dataset or 'data_subset' for a subset

NUM_EPOCHS = (
    3  # Number of epochs for training - for default or statistical heterogeneity
)
BS = 128  # Batch size for training
AUG = False  # Whether to apply data augmentation
percent = (
